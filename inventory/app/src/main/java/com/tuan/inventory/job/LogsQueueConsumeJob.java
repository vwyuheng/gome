...
public class LogsQueueConsumeJob extends AbstractJobRunnable {
	...
	public void run() {
		...
		//构建领域对象
		final InventoryLogsScheduledDomain inventoryLogsScheduledDomain = new InventoryLogsScheduledDomain(NetUtil.getLocalAddress0(), "jobCenter:ConfirmQueueConsumeJob", lm);
		//注入仓储对象
