...
public abstract class GoodsSelectionListDomain extends AbstractGoodsInventoryDomain{
	 ...
	 * @return
	 */
	public static GoodsSelectionListQueryDomain makeGoodsSelectionListQueryDomain(RequestPacket packet,String goodsId,LogModel lm,Message traceMessage){
				return GoodsSelectionListQueryDomain.makeInstance(packet,goodsId,lm,traceMessage);
	}
