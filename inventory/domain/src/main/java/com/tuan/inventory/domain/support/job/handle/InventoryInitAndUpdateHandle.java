...
public class InventoryInitAndUpdateHandle  {
	...
	/*public boolean saveGoodsWmsInventory(final long goodsId ,final GoodsInventoryWMSDO wmsDO,final List<GoodsSelectionDO> selectionList) {
		...
		try {
			// 消费对列的信息
			callResult = synInitAndAysnMysqlService.saveGoodsWmsInventory(goodsId,wmsDO,selectionList);
	...
	public boolean saveGoodsWmsInventory(final long goodsId,final GoodsInventoryWMSDO wmsDO,final List<GoodsInventoryDO> wmsInventoryList,final List<GoodsSelectionDO> selectionList) {
		boolean isSuccess = true;
		String message = StringUtils.EMPTY;
		...
		try {
			// 消费对列的信息
			callResult = synInitAndAysnMysqlService.saveGoodsWmsInventory(goodsId,wmsDO,wmsInventoryList,selectionList);
			PublicCodeEnum publicCodeEnum = callResult
					.getPublicCodeEnum();
	...
	public boolean updateGoodsInventory(final Long goodsId,final GoodsInventoryDO goodsDO) {
		boolean isSuccess = true;
		String message = StringUtils.EMPTY;
		if(goodsDO == null){
			isSuccess = false;
		...
		try {
			...
			//if (goodsDO != null) {
			// 消费对列的信息
			callResult = synInitAndAysnMysqlService.updateGoodsInventory(goodsId,goodsDO);
			PublicCodeEnum publicCodeEnum = callResult
					.getPublicCodeEnum();
	...
	public boolean updateGoodsInventory(final Long goodsId,final int adjustNum,final GoodsInventoryDO goodsDO) {
		boolean isSuccess = true;
		String message = StringUtils.EMPTY;
		if(goodsDO == null){
			isSuccess = false;
		...
		try {
			...
			//if (goodsDO != null) {
			// 消费对列的信息
			callResult = synInitAndAysnMysqlService.updateGoodsInventory(goodsId,adjustNum,goodsDO);
			PublicCodeEnum publicCodeEnum = callResult
					.getPublicCodeEnum();
	...
	public boolean updateGoodsInventory(final Long goodsId,final Map<String, String> hash,final GoodsInventoryDO goodsDO) {
		boolean isSuccess = true;
		String message = StringUtils.EMPTY;
		if(goodsDO == null){
			isSuccess = false;
