...
public class LogsServerHandler {
	private final static Log logger = LogFactory.getLog(LogsServerHandler.class);
	/**
	 * 调度线程池，用于重发数据
	 */
	...
	public static LogsServerHandler instance = new LogsServerHandler();
	 /**  队列监听等待时间 */
	...
	public static LogsServerHandler create() {
		return instance;
	}
