...
public enum PublicCodeEnum {
	...
	public static PublicCodeEnum valuesOf(int code) {
		...
		case 1017:
			return INVALID_SUPPLIERSNUM;
		case 1018:
			return SELECTION_GOODS;
		case 1019:
			return SUPPLIERS_GOODS;
		case 1020:
			return SEL_SUPP_GOODS;
		case 1021:
			return AFT_ADJUST_WATERFLOOD;
		case 1032:
			return INVALID_WMSGOODSID;
		case 1033:
			return INVALID_WMSID;
		case 1034:
			return INVALID_GOODSTYPEID;
		case 1035:
			return INVALID_SELIDANDGOODSTYPEID;
		case 1036:
			return SEL_OR_SUPP;
		case 1037:
			return AFT_ADJUST_INVENTORY;
		case 1038:
			return NONE_LIMIT_STORAGE;
		case 1039:
			return NO_SELECT_SELECTION;
		case 1040:
			return INVALID_GOODS_TYPE_ID;
		case 1041:
			return NO_WMS_DATA;
		case 1042:
			return INVALID_SELECTION_GOODSTYPEID;
		case 1043:
			return INVALID_GOODSBASEID;
		case 1044:
			return NO_GOODSBASE;
		case 1045:
			return FAILED_ORDERQUERYSERVICE;
		case 1046:
			return NO_GOODS;
		case 1047:
			return NO_SELECTION;
		case 1048:
			return NO_RETORE;
		case 1049:
			return HAD_RETORE_COMPLETED;
		case 1050:
			return NO_SUPPORT_ADJUST;
		case 1051:
			return ISGOODSIDEXIST_INVALID;
		case 2:
			return DATA_EXISTED;
		case -88:
